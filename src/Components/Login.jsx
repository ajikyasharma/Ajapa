    ...
    <div className="grid lg:grid-cols-2  mx-8 my-8  lg:my-20 lg:mx-20  h-80  items-center">
      ...
      <div className=" bg-white  shadow-sm items- p-5  drop-shadow-[35px_0_35px_rgba(0,0,0,0.25)]">
        ...
        <form className="p-4 lg:p-10" onSubmit={submitHandler}>
          <input className="w-full h-10 my-4 p-2 text-gray-700 border border-gray-400 rounded-sm" type="text" placeholder="Enter your Email or Phone" value={emailormob} onChange={(e)=>setEmailormob(e.target.value)}/>
          <br></br>
          <input className="w-full h-10 my-4 p-2 text-gray-700 border border-gray-400 rounded-sm" type="text" placeholder="Password" value={password} onChange={(e)=>setPassword(e.target.value)}/>
          <br></br>
          <select className="w-full h-10 my-4 p-2 outline-none text-gray-700 border border-gray-400 rounded-sm" name="type" id="typee" value={state} onChange={(e)=>setState(e.target.value)}>
          ...
          <input className=" text-white w-full h-10 my-4 p-2 rounded bg-orange-500 cursor-pointer" type="submit" value="Login" />
        </form>
